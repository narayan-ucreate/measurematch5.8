       ...
       <div class="row">
            <div class="col-lg-2 col-sm-2 col-xs-2 admin-sidebar">
                <ul>
                    ...
                    <li><a href="{{ url('admin/expert/servicepackages',[$expert_id],$ssl)}}" title="Published Service Packages">Published Service Packages</a></li>
                    <li class="active"><a href="{{ url('admin/expert/draftedservicepackages',[$expert_id],$ssl) }}" title="Drafted Service Packages">Drafted Service Packages</a></li>
                </ul>
            </div>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <ol class="breadcrumb">
                            ...
                            <li>Drafted Service Packages</li>
                        </ol>
                        ...
                        <table class="table table-bordered table-hover dataTable" id="example1">
                            <thead>
                                <tr>
                                    <th><a id="company_name" data="asc" href="{{url('admin/expert/draftedservicepackages/'.$expert_id.'?orderBy='.$orderBy,[],$ssl)}}">Service Package Name ({{$drafted_service_package_count}})</a></th>                                    
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <td class="published-project-action">
                                     <a title="View" href="{{ url('admin/draftedservicepackage',$service_package->id,$ssl) }}"><i class="fa fa-fw fa-eye"></i></a> 
                                
                               
                                
                                  <a title="Edit" href="{{ url('admin/editservicepackage?draft=true',$service_package->id,$ssl) }}">
                                  <i data-id="{{$service_package->id}}" class="fa fa-pencil editUser"></i></a>
                                    </td>                               
                                </tr>
                                @endforeach 
                                @else
                                <tr><td colspan="5">This expert currently has no drafts</td></tr>
                                @endif
                            </tbody>
                        </table>
                        @include('admin.admin.servicePackagePagination')
                        @if($drafted_service_package_count)
                            <a href="{{ url("admin/exportdraftedservicepackages",[$expert_id],$ssl) }}" class="export-report pull-right">Export all Drafted Service Packages of expert</a>
                        @endif
                    </div>
                    <!-- /.box-body -->
                </div>
