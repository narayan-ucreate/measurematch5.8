...
@section('content')
                ...
                <div id="submit_project_panel">
                    ...
                    <div class="col-md-9 rightcontent-panel">
                        <div class="theiaStickySidebar">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 postproject-rightside rightSidebar">
                                <div class="theiaStickySidebar">
                                    <div class="post-description-box margin-top-20">
                                        ...
                                        <p class="font-16"><strong class="gilroyregular-semibold">Review:</strong> The MeasureMatch team will check it for relevance & clarity.</p>
                                        <p class="font-16"><strong class="gilroyregular-semibold">Publish:</strong> It's posted to the MeasureMatch platform and relevant Experts are notified.</p>
                                        <p class="font-16"><strong class="gilroyregular-semibold">Pitch:</strong> You'll start to receive Expressions of Interest from MeasureMatch Experts to start discovery, scoping & pricing conversations!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @if((Auth::user()->admin_approval_status == config('constants.APPROVED')) && !isFirstProject() && !$expression_of_interest_count && !$page_already_visited)
        @include('buyer.postjobs.new_buyer_approved_pop_up')
    @endif
